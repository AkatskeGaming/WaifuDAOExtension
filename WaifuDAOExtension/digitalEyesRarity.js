...
function showRanking() {
  let matchingElements = document.evaluate("//p[contains(text(),'Waifu #')]", document, null, XPathResult.ANY_TYPE, null);
  ...
  nodes.forEach((element) => {
    ...
    if (waifu != undefined) {
      ...
      element.innerHTML = "Waifu  #" + waifuNumber + "<br>Rarity " + rarity + " Rank " + waifu.rank
      element.classList.add('rarity-' + getRating(rarity)) 
    }
  })
